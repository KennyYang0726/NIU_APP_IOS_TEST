...
struct ScoreInquiryTabView: View {
    
    @EnvironmentObject var appState: AppState
    @StateObject private var viewModel = ScoreInquiryTabViewModel()
        ...
        AppBar_Framework(title: "Score_Inquiry") {
            VStack(spacing: 0) {
                ...
                GeometryReader { geometry in
                    ...
                    let pages: [AnyView] = [
                        AnyView(ScoreInquiry_Tab1(vm: tab1)),
                        AnyView(ScoreInquiry_Tab2(vm: tab2))
                    ]
